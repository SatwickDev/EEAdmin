...
Author: Modularized from app/utils/progress_tracker.py
"""
...
class ProgressTracker:
    ...
    def __init__(self, websocket_handler=None, client_id: Optional[str] = None, task_id: Optional[str] = None):
        ...
        self.stage_times = {}
        self.errors = []
        logger.info(f"🔧 ProgressTracker initialized with task_id: {self.task_id}")
...
class DocumentProcessingTracker(ProgressTracker):
    ...
    def __init__(self, websocket_handler=None, client_id: Optional[str] = None, task_id: Optional[str] = None):
        ...
        logger.info(f"🔧 DocumentProcessingTracker initialized")
