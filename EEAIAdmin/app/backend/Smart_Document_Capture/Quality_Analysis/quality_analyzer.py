...
========================
Core quality analysis logic for Step 1 of the AI Document Processing Pipeline.

This module contains the DocumentQualityAnalyzer class which uses GPT-4o Vision API
to analyze document quality and determine optimal processing approach before OCR extraction.
"""
...
import io
from app.backend.WebSocket_And_ProgressUpdater import ProcessingStage
