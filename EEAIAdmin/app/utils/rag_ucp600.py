...
collection_ucp_rules = client.get_or_create_collection("ucp_rules")

def get_ucp_rules_collection():
    """Return the ucp_rules collection"""
    return collection_ucp_rules
...
def embed_and_store():
    doc_id = 0
    for fname, content in read_pdfs("ucp_rules"):
